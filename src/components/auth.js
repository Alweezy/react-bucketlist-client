...
export class Register extends React.Component {
    ...
    handleRegister(e) {
        e.preventDefault();
        axios.post('https://buck3tlist.herokuapp.com/auth/register',
            ...
            <div>
                <div className="mui-appbar">
                    <table width='100%'>
                        <tbody>
                        <tr style={s1}>
                            <td className="mui--appbar-height"> <Link to="/"> bucketList </Link> | Register</td>
...
export class Login extends React.Component {
    ...
    handleLogin(e) {
        e.preventDefault();
        axios.post('https://buck3tlist.herokuapp.com/auth/login',
            ...
            <div>
                <div className="mui-appbar">
                    <table width='100%'>
                        <tbody>
                        <tr style={s1}>
                            <td className="mui--appbar-height"> <Link to="/"> bucketList </Link> | Login </td>
